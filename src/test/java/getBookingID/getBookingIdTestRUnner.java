...
@CucumberOptions(
    features = "src/test/java/getBookingID/getBookingIDs.feature", 
    glue = "getBookingID"
)
public class getBookingIdTestRUnner extends AbstractTestNGCucumberTests {
    ...
    public void setUpSuite() {
        ExtentSparkReporter htmlReporter = new ExtentSparkReporter("GetBookingIDs-Report.html");
