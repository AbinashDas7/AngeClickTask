...
@CucumberOptions(
    features = "src/test/java/PingHealthCheck/PingHealthCheck.feature", 
    glue = "PingHealthCheck"
)
public class PingHealthTestRunner extends AbstractTestNGCucumberTests {
    ...
    public void setUpSuite() {
        ExtentSparkReporter htmlReporter = new ExtentSparkReporter("PingHealth-Report.html");
