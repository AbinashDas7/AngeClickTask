...
@CucumberOptions(
	    features = "src/test/java/partialUpdate/PartialUpdate.feature", 
	    glue = "partialUpdate"
	)
	public class PartialUpdateTestRunner extends AbstractTestNGCucumberTests {
    ...
    public void setUpSuite() {
        ExtentSparkReporter htmlReporter = new ExtentSparkReporter("PartialUpdate-Report.html");
