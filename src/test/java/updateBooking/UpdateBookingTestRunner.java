...
@CucumberOptions(
	    features = "src/test/java/updateBooking/PUT.feature", 
	    glue = "updateBooking"
	)
	public class UpdateBookingTestRunner extends AbstractTestNGCucumberTests {
    ...
    public void setUpSuite() {
        ExtentSparkReporter htmlReporter = new ExtentSparkReporter("UPDATE-Report.html");
