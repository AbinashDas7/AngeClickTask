...
@CucumberOptions(
    features = "src/test/java/getBookingDetails/featureGetBookingDetails.feature", 
    glue = "getBookingDetails"
)
public class GETTestRunner extends AbstractTestNGCucumberTests {
    ...
    public void setUpSuite() {
        ExtentSparkReporter htmlReporter = new ExtentSparkReporter("GET-Report.html");
